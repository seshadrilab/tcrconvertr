...
test_that("can build lookup tables from fastas", {
  ...
  expected_adapt <- data.frame(
    adaptive = c(
      ...
      "TCRAV01-02", "TCRAV01-02*01", "TCRAV14", "TCRAV14-01", "TCRAV14-01*01",
      "TCRAV38-01", "TCRAV38-01*01", "TCRAV38-02", "TCRAV38-02*01",
      "TCRBV29", "TCRBV29-01", "TCRBV29-01*01", "TCRBV29-01*02", "TCRBV29-or09_02",
      "TCRBV29-or09_02*01"
    ), adaptivev2 = c(
      "TCRAV01-01", "TCRAV01-01*01",
      "TCRAV01-01*02", "TCRAV01-02", "TCRAV01-02*01", "TCRAV14", "TCRAV14-01",
      "TCRAV14-01*01", "TCRAV38-01", "TCRAV38-01*01", "TCRAV38-02",
      "TCRAV38-02*01", "TCRBV29", "TCRBV29-01", "TCRBV29-01*01", "TCRBV29-01*02",
      "TCRBV29-or09_02", "TCRBV29-or09_02*01"
    ), imgt = c(
      "TRAV1-1*01",
      "TRAV1-1*01", "TRAV1-1*02", "TRAV1-2*01", "TRAV1-2*01", "TRAV14/DV4*01",
      "TRAV14/DV4*01", "TRAV14/DV4*01", "TRAV38-1*01", "TRAV38-1*01",
      "TRAV38-2/DV8*01", "TRAV38-2/DV8*01", "TRBV29-1*01", "TRBV29-1*01",
      "TRBV29-1*01", "TRBV29-1*02", "TRBV29/OR9-2*01", "TRBV29/OR9-2*01"
    ), tenx = c(
      "TRAV1-1", "TRAV1-1", "TRAV1-1", "TRAV1-2", "TRAV1-2",
      "TRAV14DV4", "TRAV14DV4", "TRAV14DV4", "TRAV38-1", "TRAV38-1",
      "TRAV38-2DV8", "TRAV38-2DV8", "TRBV29-1", "TRBV29-1", "TRBV29-1",
